    ...
    >
      ...
      <div className="flex flex-row gap-6 mt-20">
        <div className="flex flex-col items-center w-[270px]">
          ...
          <p className="mt-4 headline-sm">Ocean Energy</p>
        </div>
        <div className="flex flex-col items-center w-[270px]">
          <div className="w-28 h-28 rounded-full border border-white" />
          <p className="mt-4 headline-sm">Shipping and Ports</p>
        </div>
        <div className="flex flex-col items-center w-[270px]">
          <div className="w-28 h-28 rounded-full border border-white" />
          <p className="mt-4 headline-sm">
            {" "}
        ...
        <div className="flex flex-col items-center w-[270px]">
          <div className="w-28 h-28 rounded-full border border-white" />
          <p className="mt-4 headline-sm">Clean Marinas/Recreational Boating</p>
        </div>
        <div className="flex flex-col items-center w-[270px]">
          <div className="w-28 h-28 rounded-full border border-white" />
          <p className="mt-4 headline-sm">Ocean Data and Tech</p>
        </div>
      </div>
    </div>
  );
